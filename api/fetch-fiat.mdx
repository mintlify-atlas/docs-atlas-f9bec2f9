---
title: "fetchFiat: Account-Wide USDT Balance (Free and Locked)"
sidebarTitle: "fetchFiat"
description: "fetchFiat returns the account-wide USDT balance (free + locked). Accepts a symbol for per-symbol queue routing but the result is always account-wide."
---
